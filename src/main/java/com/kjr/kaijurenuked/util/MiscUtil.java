...
public final class MiscUtil {
    ...
    /**
     * Creates and adds a {@link MutableComponent} containing {@link TranslatableContents} to {@link KJRLanguageProvider#MANUAL_TRANSLATIONS}.
     *
     ...
     *
     * @return {@code translatableComponent} after adding it to {@link KJRLanguageProvider#MANUAL_TRANSLATIONS} for data generation.
     */
    public static MutableComponent translatableDefault(MutableComponent translatableComponent, String defaultTranslation) {
        KJRLanguageProvider.addManualTranslation(ChatFormatting.stripFormatting(translatableComponent.toString()), defaultTranslation);
